...
\shorttitle{Te Deum}
\subtitle{(A-Ed C 10)}
\scoring{S, A, T, B (coro), 2 clno (C), timp (C–G), 2 vl, b, org solo}
\repository{edition-esser-skala/hofmann-te-deum-in-C}
\version{1.1.0}
\date{2021-11-05}
\maketitle
...
This edition bases upon a copy in the Dommusikarchiv Eisenstadt. The digital version of the manuscript is available at \url{http://dommusikarchiv.martinus.at/site/werkverzeichnis/gallery/62.html} (siglum C 10; see also RISM ID 600038250).
