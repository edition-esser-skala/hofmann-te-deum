...
TeDeumBassFigures = \figuremode {
  ...
  r
  r
  <9 7>4 \bo <[8] 6>8 \bc <[7] 5> <6 4>4 <[5] 3>
  r1 %5
  r
  r
  <6 5>2. q4
  ...
  r2.
  <7->
  \bo <9 [4-]>4 <8 3> \bc <6 [5-]> %145
  \bo <9 [4-]>4 \bc <8 [3]>2
  r2.
  <7 _!>
  \bo <9 [4]>4 \bc <8 [3]> <6 5>
  \bo <9 [4]>2 \bc <8 [3]>4 %150
  <4 2>2.
  <7 _!>
  <7 5>
  <6 4>2 <[5] _!>4
  ...
  r
  r
  r4 \bo <[5 3]>4. \bassFigureExtendersOn \bc q8 \bassFigureExtendersOff r4
  <7>2 <6> %210
  <4+ 2>8 <6> <7 [4]> <[7] _+> r2
  r1
  r
