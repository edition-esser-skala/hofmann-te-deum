...
TeDeumBassi = {
	\relative c {
		...
		\partial 8 c'8\fE c4 c8 c c4 c,
		e8\p r f r e r r c'\f
		c4 c8 c c4 c,8 c
		f f f fis g4 g,8 r
		h\p r c r h r h r %5
		c e d g c, e d g
		...
		g h,\p c d e e fis fis %10
		g4 r8 h, c c c c
		h4 g'8\f g fis4 g
		fis g r g8 g
		gis gis gis gis a a c a
		e4^\critnote e, r e'8 e %15
		a a a a f f f f
		f f f f e e e d16 c
		g'8 g g g g4 r
		g8\p r g r g r r  g
		c,4 r8 c g' g r c, \noBreak %20
		g' g16\f g d g h, d g,4 r\fermata \bar "||"
		\key c \dorian \tempoSanctus c4\f c r2 \noBreak
		g'4 g r2
		c4 c, r2
		...
		c h c e,^\critnote fis e fis d g a h c d d, fis d
		...
		\key c \major \time 4/4 \tempoAeterna
		c8 \tuplet 3/2 8 { c'16 h c } e8 \tuplet 3/2 8 { c16 h c } e16. c32 h16. a32 g16. f32 e16. d32 \noBreak
		c4 r r8 c'16\p h c8 r
		r c16 h c8 r c r r c,
		d g c, c' f, f f f
		g f e r e c f r %160
		g f e c g'4 r
		c, r r8 c' r4
		r8 e, f f e f e d
		c a' f g c,16. c'32\f h16. a32 g16. f32 e16. d32
		c4 e8 f g16. d32 h16. g32 g'8 e %165
		f e h c f e r4
		r8 h c h c h a d
		g, g'\p d' h fis r fis r
		g g\f fis d g g g g
		c, c c c g' g g g %170
		r g g g gis gis gis gis
		a gis a d, e e e e
		a,4 r r8 a'16\p gis a8 r
		r8 a16 gis a8 r a r gis r
		a r gis r a, h c d %175
		e f d e a, a'\f fis d
		g g g g e4. d16 c
		f8 f a a b a^\critnote g c,
		f4 r r8 g\p g r
		r a a r r b b b %180
		c4 r8 c, f f\fE c' b16 c
		a8 f f d h! h c c
		g' g g h c h r d
		c h c h c g r e
		...
		c h16 g a8 d g,4 r
		r16 e\pE fis g a g fis e fis8 fis fis fis
		g h, c h c h a d
		g, g'\f g f! e4 r8 c
		...
		\time 3/4 \tempoInTe c'8 c, c c c c \noBreak
		g' g c, c c c
		g' g c, c e e
		f f f f g g
		a a a a e e %225
